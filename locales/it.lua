Locales['it'] = {
	...
	["clipboard"] = "Link copiato in ~b~Cipboard",
	...
	["shell_disabled"] ="Questo interno utilizza conchiglie, che sono disabilitate!",
	["access_textui"] = "Premi ~b~[E]~s~ per accedere a ~b~%s",
	["raid_notify_error"] = "Hai bisogno di ~b~ %sx %s~s~ per poter fare raid!",
	["raid_notify_success"] = "La tua proprietà è attualmente in ~b~Raided!",
