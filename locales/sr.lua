Locales['sr'] = {
	...
	["clipboard"] = "Link kopiran na ~b~Klipboard",
	...
	["menu_reset"] = "Resetuj",
	["menu_reset_desc"] = "Obriši ceo nameštaj",
	["menu_edit"] = "Izmeni",
	["menu_edit_desc"] = "Pomeri i/ili obriši nameštaj",
	["furni_command"] = "nameštaj",
	["furni_command_desc"] = "(ESX Imovina) Otvori menu nameštaja",
	["furni_command_permission"] = "Vi ~r~ne možete~s~ pristupiti tom menu-u!",
	...
	------------Command Strings-----------------------
		...
		["storage_pos_error"] = "~r~Ne možete~s~ postaviti poziciju ~b~skladišta~s~.",
		["wardrobe_pos_textui"] = "Pritisni ~b~[G]~s~ da postaviš poziciju svlačionice",
		["wardrobe_pos_success"] = "Pozicija ~b~svlačionice~s~ postavljena.",
		...
		["nobody_home"] = "Izgleda da nikoga nema kod kuce...",
		...
		["shell_disabled"] ="Ovaj enterijer koristi shell-ove, koji su iskljućeni!",
		...
		["manual_save"] = "Manualno čuvanje (Pokrenuto od %s)",
